...
#ifdef _LINUX
    typedef DWORD (*InitializeCP_Ptr)(void);
    typedef DWORD (*InitializeUNICODE_Ptr)(void);
    typedef DWORD (*UnInitializeCP_Ptr)(void);
    typedef DWORD (*AddTSPacketCP_Ptr)(BYTE*);
    typedef DWORD (*ClearCP_Ptr)(void);
    typedef DWORD (*GetTagInfoCP_Ptr)(LANG_TAG_INFO_DLL**, DWORD*);
    typedef DWORD (*GetCaptionDataCP_Ptr)(unsigned char, CAPTION_DATA_DLL**, DWORD*);

    InitializeCP_Ptr pfnInitializeCP;
    InitializeUNICODE_Ptr pfnInitializeUNICODE;
    UnInitializeCP_Ptr pfnUnInitializeCP;
    AddTSPacketCP_Ptr pfnAddTSPacketCP;
    ClearCP_Ptr pfnClearCP;
    GetTagInfoCP_Ptr pfnGetTagInfoCP;
    GetCaptionDataCP_Ptr pfnGetCaptionDataCP;
#else
