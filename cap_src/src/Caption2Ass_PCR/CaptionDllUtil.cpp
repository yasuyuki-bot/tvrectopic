...
#ifdef _LINUX
    pfnInitializeCP = ::InitializeCP;
    pfnUnInitializeCP = ::UnInitializeCP;
    pfnAddTSPacketCP = ::AddTSPacketCP;
    pfnClearCP = ::ClearCP;
    pfnGetTagInfoCP = ::GetTagInfoCP;
    pfnGetCaptionDataCP = ::GetCaptionDataCP;
    m_hModule = (HMODULE)1;
    return TRUE;
#else
#ifdef _AMD64_
...
#ifdef _LINUX
    pfnInitializeUNICODE = ::InitializeUNICODE;
#else
