...
//          dwStart++;
            ...
            if (m_PayloadList.size() == 0) {
                //繝ｪ繧ｹ繝医↓雋ｯ縺ｾ縺｣縺ｦ縺・↑縺・・縺ｫ髢句ｧ九ヵ繝ｩ繧ｰ縺ｮ縺､縺・◆繝代こ繝・ヨ縺倥ｃ縺ｪ縺・
                Clear();
                return ERR_NOT_FIRST;
            }
        }
        if (ucPayloadOffset != 0 && m_PayloadList.size()>0) {
            //繧ｪ繝輔そ繝・ヨ縺ゅｋ縺ｨ縺・≧縺薙→縺ｯ蜑阪・繝・・繧ｿ縺ゅｊ
            if (dwStart + ucPayloadOffset > 188)
                //繧ｵ繧､繧ｺ188莉･荳翫→縺九≠繧翫∴縺ｪ縺・
            ...
            //蜈ｨ驛ｨ雋ｯ縺ｾ縺｣縺溘・縺壹↑縺ｮ縺ｧ隗｣譫蝉ｽ懈･ｭ縺ｫ蜈･繧・
        ...
        if ((m_bAnalyz == FALSE || dwStart > 188) && (ph.PayloadStartFlag == 1)) {
            //隗｣譫舌＠縺ｦ縺ｪ縺・・縺ｫ谺｡縺ｮ髢句ｧ九ヱ繧ｱ繝・ヨ縺後″縺・
            //繝代こ繝・ヨ鬟帙ｓ縺ｧ繧句庄閭ｽ諤ｧ縺ゅｋ縺ｮ縺ｧ繧ｨ繝ｩ繝ｼ
            Clear();
            return ERR_INVALID_PACKET;
        }
        if (dwStart >= 188) {
            //繧｢繝繝励ユ繝ｼ繧ｷ繝ｧ繝ｳ縺倶ｽ輔°縺ｧ繝壹う繝ｭ繝ｼ繝峨↑縺上↑縺｣縺滂ｼ・
            Clear();
            return dwRet;
        }
        m_bAnalyz = FALSE;

        //縺ｨ繧翫≠縺医★繝・・繧ｿ繧偵Μ繧ｹ繝医↓遯√▲霎ｼ繧
        PAYLOAD_DATA *stData = new PAYLOAD_DATA;
        ...
        BOOL bNext = TRUE;
        if (ph.PayloadStartFlag == 1) {
            //繧ｹ繧ｿ繝ｼ繝医ヵ繝ｩ繧ｰ縺溘▲縺ｦ繧九・縺ｧ縺薙ｌ縺縺代〒繝・・繧ｿ縺溘∪縺｣縺ｦ繧九°繝√ぉ繝・け
            m_dwNowReadSize = 0;
            m_dwNeedSize = 0;
