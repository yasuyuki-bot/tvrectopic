...
import { Trash2, ListX, X, AlertTriangle } from 'lucide-react';

const BulkDeleteConfirmDialog = ({ isOpen, onClose, onConfirm, count }) => {
    ...
    return (
        <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="bg-white rounded-xl shadow-2xl max-w-md w-full overflow-hidden animate-in fade-in zoom-in duration-200">
                ...
                {/* Body */}
                <div className="p-6">
                    <div className="flex items-center gap-3 text-red-600 bg-red-50 p-3 rounded-lg border border-red-100 mb-4">
                        <AlertTriangle className="w-5 h-5 shrink-0" />
                        <p className="font-bold">選択した {count} 件の番組を削除しますか？</p>
                    </div>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        >
                            ...
                            <div>
                                <span className="block font-bold text-gray-900 group-hover:text-red-700">ファイルも一括削除する</span>
                                <span className="text-xs text-gray-500">選択したすべての録画データとリストを削除します</span>
                            </div>
                        </button>
                        ...
                        >
                            ...
                            <div>
                                <span className="block font-bold text-gray-900 group-hover:text-blue-700">ファイルは残してリストから削除</span>
